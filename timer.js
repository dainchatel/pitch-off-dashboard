    ...
    container.innerHTML = `
        <div style="margin-top: 15px; padding: 15px; background: #f8f9fa; border-radius: 10px;">
            ...
            <div style="margin-top: 10px;">
                <span style="color: #667eea;">📍 20:00</span> - ${selectedSegments[20] ? selectedSegments[20].name : 'None'}
            </div>
            <div style="margin-top: 5px;">
                <span style="color: #667eea;">📍 10:00</span> - ${selectedSegments[10] ? selectedSegments[10].name : 'None'}
            </div>
        </div>
    `;
}
